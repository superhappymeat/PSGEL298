#!/bin/bash
####################################################################################
#        Name: GEL.400.Delete.Environment.sh                                       #
...
if [ "$input" = "Y" ]; then
  # Detach GEL Azure Container Registry - ensures RBAC is cleaned up easily - takes 2 mins to run
  printf "\n\nStarting the clean-up, this will take around 15 to 20 minutes to run.\n"
  printf "\nDetaching the  GEL Azure Container Registry - this takes around 2 mins to run.\n"
